...
if __name__ == '__main__':
    ...
    # Reading outputs with or without reading the results for the different layers
    ...
    if print_layer_balance_other == True :
        ...
        heat_low_t_dhn_layer_plot = es.plot_layer_balance_td(outputs['layer_HEAT_LOW_T_DHN'], title='DHN heat layer balance during the different typical days', number_tds=number_tds)
