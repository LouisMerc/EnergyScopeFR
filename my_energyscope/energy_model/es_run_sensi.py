...
Modified to enable the continuation of the sensibility analysis if an error occur during one run 
for a specific value in the sensibility 
@author: Paolo Thiran
"""
...
from my_energyscope import print_run

def run_es_sensi(config):
    """

    :param config: configuration
    :return: False if the run didn't converge 
